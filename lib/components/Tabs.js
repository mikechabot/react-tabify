...
var Tabs = function (_React$Component) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            if (_index2.default.__hasValue(activeKey) && _index2.default.__hasValue(defaultActiveKey)) {
                throw new Error('Mixing controlled and uncontrolled props. Specify an "activeKey" or a "defaultActiveKey", but not both');
            }

            if (_index2.default.__hasValue(defaultActiveKey) && onSelect) {
            ...
            var activeTabKey = _index2.default.__hasValue(activeKey) ? activeKey : this.state.uncontrolledTabKey;
