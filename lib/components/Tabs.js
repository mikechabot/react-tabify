...
var Tabs = function (_React$Component) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var tabsTheme = _extends({}, _index.theme, this.props.theme);
        ...
        value: function _getActiveKey() {
            return _common2.default.__hasValue(this.props.activeKey) ? this.props.activeKey : this.state.uncontrolledActiveKey;
        }
    }, {
        ...
        value: function _getLIWrapper() {
            return this._isStacked() ? _index.StackedLI : _index.LI;
        }
    }, {
        key: '_getULWrapper',
        value: function _getULWrapper() {
            return this._isStacked() ? _index.StackedUL : _index.UL;
        }
    }, {
        key: '_getLinkWrapper',
        value: function _getLinkWrapper() {
            return this._isStacked() ? _index.StackedLink : _index.Link;
        }
    }, {
        key: '_isStacked',
...
function __hasValues() {
    ...
    return values.every(function (value) {
        return _common2.default.__hasValue(value);
    });
}
